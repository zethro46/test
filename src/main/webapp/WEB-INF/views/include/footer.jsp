...
<footer class="text-black pt-3 pb-3 ">
	<div class="container">
		<div class="row ">
			<div class="col-md-3 col-lg-3 col-sm-3 me-auto">
				<a class="navbar-brand" href="#"> <img
					src="${company.logoFooterImg }" alt="Logo"  width="100" height="100">
				</a>
				<!-- End Logo -->
			</div>
			...
			<div class="col-md-3 col-lg-3 col-sm-3 ms-auto text-center">
				<ul class="list-unstyled list-inline">
					<li class="list-inline-item"><a href="#"
						class="btn-floating btn-sm text-black" style="font-size: 20px;"><i
		...
		<div class="row text-center text-md-left">
			...
			<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
				<h5 class="text-uppercase mb-4 font-weight-bold text-black">
				...
				<c:forEach begin="1" end="5" varStatus="status" var="c"
					...
					<p>
						<a href="product/index.htm?categoryId=${c.categoryId }"
							class="text-black" style="text-decoration: none;">${c.name }</a>
					</p>
				</c:forEach>
			</div>
			...
			<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
				...
				<p>
					<a href="#" class="text-black" style="text-decoration: none;">Payment</a>
				</p>
				<p>
					<a href="#" class="text-black" style="text-decoration: none;">Shipping</a>
				</p>
				<p>
					<a href="#" class="text-black" style="text-decoration: none;">FAQ</a>
				</p>
				<p>
					<a href="#" class="text-black" style="text-decoration: none;">Shop
						Checkout</a>
				</p>
				<p>
					<a href="#" class="text-black" style="text-decoration: none;">Product
						Returns</a>
				</p>
			...
			<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
				...
				<p>
					<a href="product/index.htm?categoryId=${firstCategory }"
						class="text-black" style="text-decoration: none;"><s:message
							code="global.nav_item2" /> </a>
				</p>
				<p>
					<a href="#" class="text-black" style="text-decoration: none;"><s:message
		...
		<div class="text-center">
			<p>
				...
				<a href="#" style="text-decoration: none;"><strong
					class="text-warning" style="color: #00755D !important;" >Foot Flower</strong></a>
			</p>
